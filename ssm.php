...
<?php
global $offer;
$offer = "ПОСТАВКА ДИЗЕЛЬНЫХ ГЕНЕРАТОРОВ <span>ССМ</span> ПО ВСЕЙ РОССИИ ПОД КЛЮЧ <span>ОТ 1 ДНЯ СО СКИДКОЙ ДО 50% И ОТСРОЧКОЙ ПЛАТЕЖА</span>"
?>
<main id="mainblock">
        ...
        <div class="wrap">
            ...
            <div class="qwiz-inner qwiz-open-inner ">
                <form class="qwiztest" id="form_quiz_1">
                    ...
                    <input name="form_subject" value="КВИЗ ССМ" type="hidden">
